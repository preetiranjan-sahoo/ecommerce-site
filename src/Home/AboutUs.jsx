...
const subTitle = "Mereko choose kiun kare";
// const subTitle = "Why Choose Us";
const title = "Become a Marchant";
const desc =
  "Lorem ipsum dolor sit amet consectetur adipisicing elit. Alias inventore reiciendis sit mollitia. Quos molestiae officia sequi consectetur, ullam animi.";
// const desc =
          ...
          <div className="row g-4 justify-content-center align-items-center row-cols-1 row-cols-md-2 row-cols-xl-3">
            ...
            <div className="col">
              <div className="instructor-thumb">
                <img src="/src/assets/images/instructor/logo2.png" alt="" />
              </div>
            </div>
          </div>
        </div>
